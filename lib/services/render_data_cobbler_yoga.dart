...
class RenderDataYogaCobbler extends StatefulWidget {
  ...
  RenderDataYogaCobbler(
      {this.data, this.previewH, this.previewW, this.screenH, this.screenW});
  @override
  _RenderDataYogaCobblerState createState() => _RenderDataYogaCobblerState();
}

class _RenderDataYogaCobblerState extends State<RenderDataYogaCobbler> {
...
//
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    print('hizduvcjsklvsndjbs dfjdsvkfgvbksd, skjdvhs d');
    print('left wrist ===');
    print(leftWristY);
    ...
    if ((leftelbowX > 300 && leftelbowX < 350 && rightelbowX > 90 && rightelbowX < 120) || (leftWristY > 700 &&
        rightWristY > 700 &&
        leftWristX > 230 &&
        rightWristX > 120 &&
        leftShoulderY > 445 &&
