...
class RenderDataYogaCowFace extends StatefulWidget {
  ...
  RenderDataYogaCowFace(
      {this.data, this.previewH, this.previewW, this.screenH, this.screenW});
  @override
  _RenderDataYogaCowFaceState createState() => _RenderDataYogaCowFaceState();
}

class _RenderDataYogaCowFaceState extends State<RenderDataYogaCowFace> {
...
//
  ...
  bool wristAlignment, shoulderAlignment, armAlignment, kneeAndHipAlignment;
  ...
  void _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    print('liiyuilagsyd kdjfkaokaisld kasdfg l ');
    print('left wrist ===');
    print(leftWristY);
    ...
    print('elbow == ${leftelbowX}, ${leftelbowY}, ${rightelbowX}, ${rightelbowY}');
