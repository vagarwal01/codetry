            ...
            child: Row(
              children: [
                Container(
                  height: 25,
                  width: 30,
                  child: Image.asset("assets/med/stats.png"),
                ),
                SizedBox(
                  width: 40,
                ),
                GestureDetector(
                  ...
                  child: Container(
                    height: 20,
                    width: 20,
                    child: Image.asset("assets/med/exit.png"),
                  ),
                )
              ],
            ),
      ...
      child: Stack(
        children: [
          Positioned(
            bottom: 0,
            right: 0,
            child: Image.asset("assets/med/coltri.png"),
          ),
          Container(
                    ...
                    children: [
                      Stack(
                        children: [
                          Container(
                            height: 100,
                            child: Image.asset("assets/med/trithin.png"),
                          ),
                          Positioned(
                            top: 50,
                            left: 40,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 25,
                              width: 20,
                              child: Image.asset("assets/med/circle.png"),
                            ),
                            Text(
                              "PLAY",
                              style: TextStyle(
            ...
            child: Row(
              ...
              children: [
                Container(
                  height: 20,
                  width: 20,
                  child: Image.asset("assets/med/clock.png"),
                ),
                Container(
                  height: 20,
                  width: 20,
                  child: Image.asset("assets/med/equalizer.png"),
                ),
              ],
            ),
          )
