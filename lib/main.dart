...
Future<Null> main() async {
  ...
  var initializationSettingsAndroid = AndroidInitializationSettings('om');
...
class MyHome extends StatefulWidget {
  ...
  const MyHome({Key key, this.cameras}) : super(key: key);
                              ...
                              children: <Widget>[
                                TrackingTextInput(
                                  ...
                                  onTextChanged: (String value) {
                                    _teddyController.setSIEmail(value);
                                  },
                                ),
                                TrackingTextInput(
                                  label: "Password",
                                  ...
                                  onTextChanged: (String value) {
                                    _teddyController.setSIPassword(value);
                                  },
                                ),
                                SigninButton(
                                    child: Text("SIGN IN",
                                    ...
                                    onPressed: () {
                                      _teddyController.signIn(context);
                                    }),
                                MaterialButton(
