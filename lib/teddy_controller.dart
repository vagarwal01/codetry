...
// Get caret in Flare world space.
  ...
  void setSUPassword(String value) {
    _SUpassword = value;
  }
  void setSUUsername(String value) {
    _SUusername = value;
  }
  void setSUEmail(String value) {
    _SUemail = value;
  }
  void setSIPassword(String value) {
    _SIpassword = value;
  }
  void setSIEmail(String value) {
    _SIemail = value;
  }
  ...
  void signup(context) async {
    if(_SUusername == null || _SUemail == null || _SUpassword == null) {
      play("fail");
    } else {
      play("success");
      print(_SUemail.trim() + _SUpassword + _SUusername);
      signUp(_SUemail.trim(), _SUpassword.trim(), _SUusername.trim(), context).then((value) {
        if (value != null) {
  ...
  void signIn(context) async {
    print('signin');
    if(_SIemail == null || _SIpassword == null) {
      play("fail");
    } else {
      play("success");
      print(_SIpassword + _SIemail);
      signin(_SIemail.trim(), _SIpassword.trim(), context).then((value) {
        if (value != null) {
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
